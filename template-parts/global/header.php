    ...
    <section class="container mx-auto grid-design">
        <div class="relative col-span-full flex justify-between py-6">
            ...
            ">
                ...
                <li>
                    <a href="#" class="flex items-center p-4 text-white mix-blend-difference outline-none focus:bg-white/10">
                        About
                    </a>
                </li>

                <li>
                    <a href="#" class="flex items-center py-4 pl-4 pr-6 text-white mix-blend-difference outline-none focus:bg-white/10">
                        Contact
                    </a>
                </li>
